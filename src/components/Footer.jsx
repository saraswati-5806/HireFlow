...
export default function Footer() {
  ...
  const handleCandidateRedirect = (targetRoute) => {
    if (currentUser?.role === "Candidate") {
      ...
      alert("Candidate access only. Please log in as a Candidate.");
      navigate("/login");
    }
  };
  ...
  return (
    <footer style={{ background: "#0f172a", color: "#94a3b8", paddingTop: "3.5rem", paddingBottom: "2rem", borderTop: "4px solid #0d9488", fontFamily: "sans-serif" }}>
      <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "0 1.5rem", display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: "2.5rem" }}>
        ...
        {/* SECTION 1: BRANDING & GENUINE SVG BRAND ICONS */}
        <div>
          ...
          {/* Authentic SVG Icons Grid */}
          <div style={{ display: "flex", gap: "1.25rem", alignItems: "center" }}>
            {/* GMAIL */}
            <a href="mailto:support@hireflow.edu" title="Email Support" style={{ transition: "transform 0.2s" }} onMouseEnter={(e) => e.currentTarget.style.transform = "scale(1.1)"} onMouseLeave={(e) => e.currentTarget.style.transform = "scale(1)"}>
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M22 6V9L12 15L2 9V6L12 12L22 6Z" fill="#C5221F"/>
                <path d="M2 6V18C2 19.1 2.9 20 4 20H6V9L2 6Z" fill="#F4B400"/>
                <path d="M22 6V18C22 19.1 21.1 20 20 20H18V9L22 6Z" fill="#4285F4"/>
              </svg>
            </a>

            {/* LINKEDIN */}
            <a href="https://linkedin.com" target="_blank" rel="noreferrer" title="LinkedIn Network" style={{ transition: "transform 0.2s" }} onMouseEnter={(e) => e.currentTarget.style.transform = "scale(1.1)"} onMouseLeave={(e) => e.currentTarget.style.transform = "scale(1)"}>
        ...
        {/* SECTION 3: FOR EMPLOYERS (UPDATED ACCORDING TO SPECIFICATIONS) */}
        <div>
        ...
        {/* SECTION 4: COMPANY REFERENCE SHORTCUT NODES */}
        <div>
